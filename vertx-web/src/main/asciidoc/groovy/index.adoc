...
<dependency>
  ...
  <version>3.3.3-websocket</version>
</dependency>
----
...
----
dependencies {
  compile 'io.vertx:vertx-web:3.3.3-websocket'
}
----
...
`io.vertx:vertx-web-templ-mvel:3.3.3-websocket`. Create an instance of the MVEL template engine using:
...
`io.vertx:vertx-web-templ-jade:3.3.3-websocket`. Create an instance of the Jade template engine using:
...
`io.vertx:vertx-web-templ-handlebars:3.3.3-websocket`. Create an instance of the Handlebars template engine
...
`io.vertx:vertx-web-templ-thymeleaf:3.3.3-websocket`. Create an instance of the Thymeleaf template engine
...
`io.vertx:vertx-web-templ-freemarker:3.3.3-websocket`. Create an instance of the Apache FreeMarker template engine
...
[source,groovy,subs="+attributes"]
----
compile 'io.vertx:vertx-web:3.3.3-websocket:client'
----
...
inspect the raw message of the event using `link:../../groovydoc/io/vertx/groovy/ext/web/handler/sockjs/BridgeEvent.html#getRawMessage()[getRawMessage]`.
